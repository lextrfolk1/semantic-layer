...
public interface ObjectExposureReadService {
    ...
    List<ObjectExposureSummaryDto> findObjects(String clientId, String schemaCode, String lifecycleStatusCode);

    ObjectExposureDetailDto findObject(String clientId, UUID objectId);
}
